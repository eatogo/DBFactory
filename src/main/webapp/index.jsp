...
<body>
	...
	<form name="dbConnectForm" method="post">
		...
		<p>
			DB使用者名稱 <input type="text" name="dbUsername" value="${dbUsername}"
				placeholder="Username..." id="dbUsername"><span id="errorMessage"></span>
		</p>
		<p>
			DB使用者密碼 <input type="text" name="dbPassword" value="${dbPassword}"
				placeholder="Password..." id="dbPassword">
		</p>
		<input type="reset" value="重填資料">
		<hr>
		<input class="button" type="button" onclick="doSomethingOnDb(this)"
			value="建立Eatogo資料庫"> <input class="button" type="button"
			onclick="doSomethingOnDb(this)" value="建立表格"> <input
			class="button" type="button" onclick="doSomethingOnDb(this)"
			value="新增靜態資料"> <input class="button" type="button"
			onclick="doSomethingOnDb(this)" value="新增動態(假)資料"> <input
			class="button" type="button" onclick="doSomethingOnDb(this)"
			value="新增Views">
	</form>
</body>
