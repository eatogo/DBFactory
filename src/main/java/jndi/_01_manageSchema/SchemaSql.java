...
public class SchemaSql {
	...
	public void dropAllConstraints() {
		try {
			...
			System.out.println("清除constraint錯誤");
			e.printStackTrace();
		}
	}
	...
	public void addAllConstraints() {
		try {
			...
			System.out.println("建立constraints錯誤");
			e.printStackTrace();
		}
	}
