...
CREATE TABLE `USERS` (user_id INT PRIMARY KEY NOT NULL AUTO_INCREMENT, user_password VARCHAR(50) NOT NULL, user_cellphone VARCHAR(20) NOT NULL, user_name VARCHAR(50) NOT NULL, user_email VARCHAR(50), user_avatar VARCHAR(255) DEFAULT 'default.png', user_create_time DATETIME NOT NULL, user_status VARCHAR(20) NOT NULL DEFAULT 'unverified', user_identity VARCHAR(20) NOT NULL DEFAULT 'consumer', user_store INT);
