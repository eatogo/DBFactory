...
<body>
	...
	<form name="dbConnectForm" method="post">
		<p>DB使用者名稱 <input type="text" name="dbUsername" value="${dbUsername}" placeholder="Username..." id="dbUsername" required></p>
		<p>DB使用者密碼 <input type="text" name="dbPassword" value="${dbPassword}" placeholder="Password..." id="dbPassword"></p>
